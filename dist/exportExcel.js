...
function exportExcel() {
    var _a, _b;
    const { localeFileType, excelPath, outputExcelPath } = stateManager_1.default.getToolConfig();
    ...
    fs_extra_1.default.writeFileSync((0, getAbsolutePath_1.getAbsolutePath)(process.cwd(), outputExcelPath !== null && outputExcelPath !== void 0 ? outputExcelPath : excelPath), excelBuffer, 'utf8');
}
